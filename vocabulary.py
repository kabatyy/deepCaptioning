"""Creates and manages a vocabulary of words extractred from the captions of the COCO dataset"""
import nltk
import pickle 
import os
...
class Vocabulary:
    def __init__(self,
                 ...
                 end_word="<end>",
                 unk_word="<unk>",
                 annotations_file="/content/project/deepCaptioning/cocoapi/annotations/captions_train2014.json",
