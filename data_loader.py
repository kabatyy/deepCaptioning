"""prepares and loads data from the COCO datatset and creates a data pipeline
   that handles images and captions(for training and validation) or just images for testing"""
import nltk
import os
import torch
